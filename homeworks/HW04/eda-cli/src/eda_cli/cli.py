...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Присутствуют константные столбцы: **{quality_flags['has_constant_columns']}**\n\n")
        f.write(f"- Слишком много категориальных значений в 1 столбце: **{quality_flags['has_high_cardinality_categoricals']}**\n\n")
