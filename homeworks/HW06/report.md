...
|----------------------|----------|---------|---------|
| DummyClassifier      | 0.615    | 0.266   | 0.503   |
| LogisticRegression   | 0.812    | 0.561   | 0.798   |
| DecisionTree         | 0.838    | 0.658   | 0.837   |
| RandomForest         | 0.889    | 0.749   | 0.926   |
| **GradientBoosting** | **0.903**| **0.802**| **0.928**|
